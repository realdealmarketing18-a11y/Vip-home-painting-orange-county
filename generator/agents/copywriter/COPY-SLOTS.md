...
0. **`context/FABIAN.md`** — how Fabian works. Governs everything below.
0b. **`context/ABOUT-VIP.md`** and **`context/DREAM-CUSTOMER.md`** — who we are, who we serve. Every headline
