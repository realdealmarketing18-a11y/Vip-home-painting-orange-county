...
function discover() {
  ...
  return out.sort((a, b) => a.depth - b.depth);   // parents before children
}
...
function buildContent(x) {
  return `<!-- GENERATED by generator/publish-wp.js — do not edit in WordPress.
...
(async () => {
  ...
  console.log(LIVE ? '*** LIVE — this writes to WordPress ***\n' : 'DRY RUN — nothing will be written. Add --live to publish.\n');
  ...
  for (const p of pages) {
    ...
    const payload = {
      ...
      meta: {
        ...
        rank_math_canonical_url: x.canonical
      }
    };
