...
| `memory/decisions.md` | D-01…D-13 — architectural choices and the reason behind each |
...
**Turning on the Step Five photo upload at launch:** `docs/LEAD-INTAKE-GUIDE.md` — plain-English checklist.
...
Shared: `SALES-PAGE-TEMPLATE.md` — **the locked section order** for every sales page, with
the story beat, conversion job, headline formula and schema per section. Also
`HEADLINE-FORMULAS.md` — **Part 0 is the three rules every headline passes**
